...
public:
    ...
    bool BuildMeshProgram(const Shader& meshShader, const Shader& fragmentShader);
    bool BuildTaskMeshProgram(const Shader& taskShader, const Shader& meshShader, const Shader& fragmentShader);
