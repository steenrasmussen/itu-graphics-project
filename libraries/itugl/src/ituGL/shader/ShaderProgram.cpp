...
bool ShaderProgram::BuildMeshProgram(const Shader &meshShader, const Shader &fragmentShader) {
    assert(meshShader.IsType(Shader::MeshShaderNv));
    AttachShader(meshShader);
...
bool
ShaderProgram::BuildTaskMeshProgram(const Shader &taskShader, const Shader &meshShader, const Shader &fragmentShader) {
    assert(taskShader.IsType(Shader::TaskShaderNv));
    AttachShader(taskShader);
